...
error_reporting(E_ALL ^ E_NOTICE);
			...
			if($conn=conectarpg()){
				$query="select * from vista_04 where cod_caja='".$_GET['xcod_caja']."' and fecha='".$_GET['xfecha']."' and num_cuen='". $_GET['xnum_cuen'] ."' order by n_recibo desc";
				if($result=pg_query($query)){
					echo "<table class='table' id='tabla1' name='tabla1'>";
					echo "<tr><th colspan='10'>Listado de Depositos - Cuenta Bancaria:". $_GET['xnum_cuen'] ." Caja #: ".$_GET['xcod_caja']." de Fecha: ". $_GET['xfecha'] ."</th></tr>";
					echo "<tr>";
