...
echo "<form method='post' action='php/ingresos_rango_cpto.php' target='contenido1'";
echo "<center>";
echo "	<table>";
echo "<tr><th colspan='4'>Ingrese Rango de Fechas a Consultar (Ingresos Por Concepto) </th></tr>";
