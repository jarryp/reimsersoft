...
echo "<form method='post' action='php/ingresos_resumen_diario.php' target='contenido1'";
echo "<center>";
echo "	<table>";
echo "<tr><th colspan='3'>Ingrese Rango de Fechas a Consultar</th></tr>";
echo "<tr><td><input type='date' name='fecha1' id='fecha1' size='12' placeholder='yyyy-mm-dd' required='required' /></td>";
echo "<td><input type='date' name='fecha2' id='fecha2' size='12' placeholder='yyyy-mm-dd' required='required' /></td>";
